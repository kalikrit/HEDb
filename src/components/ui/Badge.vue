...
const variantClasses = computed(() => {
  const classes = {
    success: "bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100", // Инвертировано для контраста
    ...
    primary: "bg-purple-100 text-purple-800 dark:bg-purple-800 dark:text-purple-100",
